...
<body>
	<div class="w3-container ">
		<form class="w3-container" method="POST">
			<center><h2>Choose your Item</h2></center>
			<select class="w3-select w3-border" name="option">
    		<option value="" disabled selected>Choose your option</option>
    		<option value="1">Sanitizer</option>
   			<option value="2">Mask</option>
   			<option value="3">Gloves</option>
  </select>
  <br>
  <br>
  <input class="w3-button  w3-right" type="submit" name="form_submit">
  <br>
  <br>
  <br>
		</form>
	...
	<div class="w3-container w3-half w3-margin-top w3-container w3-card-4">
		...
		<table class="w3-table">
			...
			<tr>
				<td>Quantity</td>
				<td><input class="w3-input" type="text" name="qty"></td>
			</tr>
			<br>
		</table>
		<br>
		<input class="w3-button w3-right" type="submit" name="qty_sub">
		<br><br><br>
		</form>
	</div>
